...
- Afectará el proveedor de tarjetas, la persistencia de snapshots, el comando de preparación/importación y la documentación de despliegue; no requiere una migración SQL adicional.
